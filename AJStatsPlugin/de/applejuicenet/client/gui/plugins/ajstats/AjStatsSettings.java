...
public class AjStatsSettings extends JPanel {
	...
	public AJStatsPlugin parent = null;
	...
	protected void finalize() throws Throwable {
		...
		parent.getProperties().put("changed","true");
		parent.saveProperties();

		super.finalize();
	}
	public AjStatsSettings(){
	}
	...
	private javax.swing.JButton getBtnBGColorBegin() {
		if (btnBGColorBegin == null) {
			try {
				...
				btnBGColorBegin.addActionListener(new java.awt.event.ActionListener() { 
	...
	private javax.swing.JButton getBtnBGColorEnd() {
		if (btnBGColorEnd == null) {
			try {
				...
				btnBGColorEnd.addActionListener(new java.awt.event.ActionListener() { 
	...
	private javax.swing.JComboBox getCmbBGDirection() {
		if (CmbBGDirection == null) {
			try {
				...
				CmbBGDirection.addActionListener(new java.awt.event.ActionListener() { 

					public void actionPerformed(java.awt.event.ActionEvent e) {    
						
						parent.getProperties().put("GradientDirection", Integer.toString(CmbBGDirection.getSelectedIndex()));
					}
				});
